...
test: test-go test-alipay-beancount test-alipay-ledger test-wechat-beancount test-wechat-ledger test-huobi-beancount test-huobi-ledger test-htsec-beancount test-htsec-ledger test-icbc-beancount test-icbc-ledger test-ccb-beancount test-ccb-ledger test-td-beancount test-td-ledger test-bmo-beancount test-bmo-ledger test-bocom_credit-beancount test-bocom_credit-ledger test-citic-beancount test-citic-ledger test-hsbchk-beancount test-hsbchk-ledger test-jd-beancount test-jd-ledger test-mt-beancount test-hxsec-beancount test-cmb-beancount test-cmb-ledger ## Run all tests
...
test-bocom_credit-beancount: ## Run tests for Bocom Credit provider against beancount compiler
	@$(SHELL) ./test/bocom_credit-test-beancount.sh
test-bocom_credit-ledger: ## Run tests for Bocom Credit provider against ledger compiler
	@$(SHELL) ./test/bocom_credit-test-ledger.sh
